...
$con = new DB_con();
// data insert code starts here   insertar informacion inicia aqui.
if(isset($_POST['btn-save']))
{
	...
	$res=$con->servicio_d($destino,$coordenada_x,$coordenada_y,$nombre_d,$ci_d,$cel_d,$row[0]);
	if($res)
	{
		?>
		<script>
		alert('Servicio solicitado con exito...');
	...
	else
	{
		?>
		<script>
		alert('error en solicitud de servicio...');
...
<!--CONTENIDO-->
  ...
  <div id="content" class="content" margin: align="center">
    ...
    <tr>
    <th class="title">DATOS DESTINO</th>
    <th class="title"> MAPA</th>
    </tr>
    <tr >
		<td class='row' >Destino:<input class="form-control" id="destino" type='text' name='destino' placeholder='Describa la direccion y el lugar'/>
		</td>
...
<?php
     ...
     <tr>
    <td>Nombre del destinatario<input class="form-control" id="nombre_d" type="text" name="nombre_d" placeholder="Nombre Completo" required /></td>
    </tr>
     <tr>
    <td>CI del destinatario:<input class="form-control" id="ci_d" type="text" name="ci_d" placeholder="C.I." required /></td>
    </tr>
		<tr>
	 <td>Celular del destinatario:<input class="form-control" id="cel_d" type="text" name="cel_d" placeholder="Celular" required /></td>
	 </tr>
	 <tr>
